...
openXml.W15 = {
    accent1: new XName(w15Ns, "accent1"),
    accent2: new XName(w15Ns, "accent2"),
    accent3: new XName(w15Ns, "accent3"),
    accent4: new XName(w15Ns, "accent4"),
    accent5: new XName(w15Ns, "accent5"),
    accent6: new XName(w15Ns, "accent6"),
    algn: new XName(w15Ns, "algn"),
    allowTightWrapping: new XName(w15Ns, "allowTightWrapping"),
    anchor: new XName(w15Ns, "anchor"),
    b: new XName(w15Ns, "b"),
    bdr: new XName(w15Ns, "bdr"),
    bdrPr: new XName(w15Ns, "bdrPr"),
    bdrSz: new XName(w15Ns, "bdrSz"),
    bdrThemeColor: new XName(w15Ns, "bdrThemeColor"),
    bdrThemeTint: new XName(w15Ns, "bdrThemeTint"),
    bdrThemeShade: new XName(w15Ns, "bdrThemeShade"),
    bdrVal: new XName(w15Ns, "bdrVal"),
    bdrColor: new XName(w15Ns, "bdrColor"),
    bdrSpace: new XName(w15Ns, "bdrSpace"),
    bdrShadow: new XName(w15Ns, "bdrShadow"),
    bdrFrame: new XName(w15Ns, "bdrFrame"),
    bdrBetween: new XName(w15Ns, "bdrBetween"),
    bdrTop: new XName(w15Ns, "bdrTop"),
    bdrLeft: new XName(w15Ns, "bdrLeft"),
    bdrBottom: new XName(w15Ns, "bdrBottom"),
    bdrRight: new XName(w15Ns, "bdrRight"),
    bdrInsideH: new XName(w15Ns, "bdrInsideH"),
    bdrInsideV: new XName(w15Ns, "bdrInsideV"),
    bdrTl2br: new XName(w15Ns, "bdrTl2br"),
    bdrTr2bl: new XName(w15Ns, "bdrTr2bl"),
    bdrStart: new XName(w15Ns, "bdrStart"),
    bdrEnd: new XName(w15Ns, "bdrEnd"),
    bdrBar: new XName(w15Ns, "bdrBar"),
    bdrBetweenPr: new XName(w15Ns, "bdrBetweenPr"),
    bdrTopPr: new XName(w15Ns, "bdrTopPr"),
    bdrLeftPr: new XName(w15Ns, "bdrLeftPr"),
    bdrBottomPr: new XName(w15Ns, "bdrBottomPr"),
    bdrRightPr: new XName(w15Ns, "bdrRightPr"),
    bdrInsideHPr: new XName(w15Ns, "bdrInsideHPr"),
    bdrInsideVPr: new XName(w15Ns, "bdrInsideVPr"),
    bdrTl2brPr: new XName(w15Ns, "bdrTl2brPr"),
    bdrTr2blPr: new XName(w15Ns, "bdrTr2blPr"),
    bdrStartPr: new XName(w15Ns, "bdrStartPr"),
    bdrEndPr: new XName(w15Ns, "bdrEndPr"),
    bdrBarPr: new XName(w15Ns, "bdrBarPr"),
    bdrThemeColorPr: new XName(w15Ns, "bdrThemeColorPr"),
    bdrThemeTintPr: new XName(w15Ns, "bdrThemeTintPr"),
    bdrThemeShadePr: new XName(w15Ns, "bdrThemeShadePr"),
    bdrValPr: new XName(w15Ns, "bdrValPr"),
    bdrColorPr: new XName(w15Ns, "bdrColorPr"),
    bdrSpacePr: new XName(w15Ns, "bdrSpacePr"),
    bdrShadowPr: new XName(w15Ns, "bdrShadowPr"),
    bdrFramePr: new XName(w15Ns, "bdrFramePr"),
    collapsed: new XName(w15Ns, "collapsed"),
    color: new XName(w15Ns, "color"),
    commentEx: new XName(w15Ns, "commentEx"),
    commentsEx: new XName(w15Ns, "commentsEx"),
    contextualSpacing: new XName(w15Ns, "contextualSpacing"),
    cs: new XName(w15Ns, "cs"),
    dataBinding: new XName(w15Ns, "dataBinding"),
    dirty: new XName(w15Ns, "dirty"),
    dispDef: new XName(w15Ns, "dispDef"),
    docId: new XName(w15Ns, "docId"),
    done: new XName(w15Ns, "done"),
    eastAsia: new XName(w15Ns, "eastAsia"),
    eastAsiaTheme: new XName(w15Ns, "eastAsiaTheme"),
    effect: new XName(w15Ns, "effect"),
    emphasis: new XName(w15Ns, "emphasis"),
    endnote: new XName(w15Ns, "endnote"),
    endnotePr: new XName(w15Ns, "endnotePr"),
    endnoteRef: new XName(w15Ns, "endnoteRef"),
    endnoteReference: new XName(w15Ns, "endnoteReference"),
    endnotes: new XName(w15Ns, "endnotes"),
    fill: new XName(w15Ns, "fill"),
    fillToRect: new XName(w15Ns, "fillToRect"),
    font: new XName(w15Ns, "font"),
    fontSz: new XName(w15Ns, "fontSz"),
    glow: new XName(w15Ns, "glow"),
    gradFill: new XName(w15Ns, "gradFill"),
    gs: new XName(w15Ns, "gs"),
    gsLst: new XName(w15Ns, "gsLst"),
    h: new XName(w15Ns, "h"),
    highlight: new XName(w15Ns, "highlight"),
    id: new XName(w15Ns, "id"),
    kx: new XName(w15Ns, "kx"),
    ky: new XName(w15Ns, "ky"),
    l: new XName(w15Ns, "l"),
    lat: new XName(w15Ns, "lat"),
    ligatures: new XName(w15Ns, "ligatures"),
    lightRig: new XName(w15Ns, "lightRig"),
    lim: new XName(w15Ns, "lim"),
    lin: new XName(w15Ns, "lin"),
    lon: new XName(w15Ns, "lon"),
    lumMod: new XName(w15Ns, "lumMod"),
    lumOff: new XName(w15Ns, "lumOff"),
    miter: new XName(w15Ns, "miter"),
    noFill: new XName(w15Ns, "noFill"),
    numForm: new XName(w15Ns, "numForm"),
    ...
    prst: new XName(w15Ns, "prst"),
    prstDash: new XName(w15Ns, "prstDash"),
    prstMaterial: new XName(w15Ns, "prstMaterial"),
    r: new XName(w15Ns, "r"),
    rad: new XName(w15Ns, "rad"),
    reflection: new XName(w15Ns, "reflection"),
    rev: new XName(w15Ns, "rev"),
    rig: new XName(w15Ns, "rig"),
    rot: new XName(w15Ns, "rot"),
    round: new XName(w15Ns, "round"),
    sat: new XName(w15Ns, "sat"),
    satMod: new XName(w15Ns, "satMod"),
    satOff: new XName(w15Ns, "satOff"),
    scaled: new XName(w15Ns, "scaled"),
    scene3d: new XName(w15Ns, "scene3d"),
    schemeClr: new XName(w15Ns, "schemeClr"),
    shade: new XName(w15Ns, "shade"),
    shadow: new XName(w15Ns, "shadow"),
    solidFill: new XName(w15Ns, "solidFill"),
    srgbClr: new XName(w15Ns, "srgbClr"),
    stA: new XName(w15Ns, "stA"),
    stPos: new XName(w15Ns, "stPos"),
    styleSet: new XName(w15Ns, "styleSet"),
    stylisticSets: new XName(w15Ns, "stylisticSets"),
    sx: new XName(w15Ns, "sx"),
    sy: new XName(w15Ns, "sy"),
    t: new XName(w15Ns, "t"),
    textFill: new XName(w15Ns, "textFill"),
    textId: new XName(w15Ns, "textId"),
    textOutline: new XName(w15Ns, "textOutline"),
    tint: new XName(w15Ns, "tint"),
    uncheckedState: new XName(w15Ns, "uncheckedState"),
    val: new XName(w15Ns, "val"),
    w: new XName(w15Ns, "w"),
    wProps3d: new XName(w15Ns, "wProps3d"),
    wScene3d: new XName(w15Ns, "wScene3d"),
    wShadow: new XName(w15Ns, "wShadow"),
    wTextFill: new XName(w15Ns, "wTextFill"),
    wTextOutline: new XName(w15Ns, "wTextOutline"),
    xfrm: new XName(w15Ns, "xfrm"),
};
var W15 = openXml.W15;
