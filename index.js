...
(function (root) {
    ...
    function defineOpenXml(Enumerable, Ltxml, XEnumerable) {
                ...
                if (thisPart !== null) {
                    if (part === "[Content_Types].xml" || (part.indexOf("[trash]") != -1)) {
                        ...
                        if (thisPart.partType === "xml" && typeof thisPart.data === "string") {
                            var data = openXml.util.encode_utf8(thisPart.data);
            ...
            for (var part in this.parts) {
                if (part !== "[Content_Types].xml") {
                    ...
                    if (thisPart !== null) {
                        ...
                        if (thisPart.partType === "xml" && typeof thisPart.data === "string") {
                            let data = openXml.util.encode_utf8(thisPart.data);
                            partContent = XDocument.parse(openXml.util.decode_utf8(data)).root;
        ...
        openXml.OpenXmlPart.prototype.getXDocument = function () {
            if (this.partType === 'xml' && typeof this.data === 'string') {
                var data = openXml.util.encode_utf8(this.data);
    ...
    // module export
    if (typeof define === typeof
        function () {} && define.amd) { // AMD
